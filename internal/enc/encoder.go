...
// (msFrame=false) for every frame regardless of the four-way PE
// comparison. Test-only hook: production code never sets it, and its zero
// value makes the DECIDE phase byte-identical to the unhooked encoder.
