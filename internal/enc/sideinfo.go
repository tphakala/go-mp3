...
// gc.scfCompress), window_switching_flag(1)=0, table_select[0..2](5
// each), region0_count(4), region1_count(3), preflag(1, from
// gc.sf.preflag), scalefac_scale(1, from gc.sf.scalefacScale),
// count1table_select(1). This is MPEG-1 write order, mirroring
// l3ReadSideInfo's read order (internal/dec/sideinfo.go:69).
//
